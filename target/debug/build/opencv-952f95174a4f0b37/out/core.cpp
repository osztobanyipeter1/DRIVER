...
extern "C" {
	...
	void cv_transposeND_const__InputArrayR_const_vectorLintGR_const__OutputArrayR(const cv::_InputArray* src, const std::vector<int>* order, const cv::_OutputArray* dst, Result_void* ocvrs_return) {
		try {
	...
	void cv_utils_testRotatedRectVector_float_float_float_float_float(float x, float y, float w, float h, float angle, Result<std::vector<cv::RotatedRect>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<std::vector<cv::RotatedRect>*>, ocvrs_return);
	}
	...
	void cv_Exception_propMsg_String(cv::Exception* instance, char* val) {
	...
	void cv_Exception_propCode_int(cv::Exception* instance, int val) {
			instance->code = val;
	}
	...
	void cv_Exception_propErr_String(cv::Exception* instance, char* val) {
	...
	void cv_Exception_propFunc_String(cv::Exception* instance, char* val) {
	...
	void cv_Exception_propFile_String(cv::Exception* instance, char* val) {
	...
	void cv_Exception_propLine_int(cv::Exception* instance, int val) {
			instance->line = val;
	}
	...
	void cv_FileNode_propBlockIdx_size_t(cv::FileNode* instance, size_t val) {
	...
	void cv_FileNode_propOfs_size_t(cv::FileNode* instance, size_t val) {
			instance->ofs = val;
	}
	...
	void cv_FileStorage_propState_int(cv::FileStorage* instance, int val) {
			instance->state = val;
	}
	...
	void cv_FileStorage_propElname_string(cv::FileStorage* instance, char* val) {
	...
	void cv_KeyPoint_propPt_Point2f(cv::KeyPoint* instance, cv::Point2f* val) {
			instance->pt = *val;
	}
	...
	void cv_KeyPoint_propSize_float(cv::KeyPoint* instance, float val) {
			instance->size = val;
	}
	...
	void cv_KeyPoint_propAngle_float(cv::KeyPoint* instance, float val) {
			instance->angle = val;
	}
	...
	void cv_KeyPoint_propResponse_float(cv::KeyPoint* instance, float val) {
	...
	void cv_KeyPoint_propOctave_int(cv::KeyPoint* instance, int val) {
			instance->octave = val;
	}
	...
	void cv_KeyPoint_propClass_id_int(cv::KeyPoint* instance, int val) {
	...
	void cv_Mat_set_Scalar(cv::Mat* instance, cv::Scalar* s, Result_void* ocvrs_return) {
		try {
			*instance = *s;
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	const unsigned char* cv_Mat_data_const(const cv::Mat* instance) {
	...
	void cv_Mat_propFlags_int(cv::Mat* instance, int val) {
			instance->flags = val;
	}
	...
	void cv_Mat_propDims_int(cv::Mat* instance, int val) {
			instance->dims = val;
	}
	...
	void cv_Mat_propRows_int(cv::Mat* instance, int val) {
			instance->rows = val;
	}
	...
	void cv_Mat_propCols_int(cv::Mat* instance, int val) {
			instance->cols = val;
	}
	...
	void cv_Mat_propData_unsigned_charX(cv::Mat* instance, unsigned char* val) {
			instance->data = val;
	}
	...
	void cv_Mat_propU_UMatDataX(cv::Mat* instance, cv::UMatData* val) {
			instance->u = val;
	}
	...
	bool cv_MatConstIterator_hasElements_const(const cv::MatConstIterator* instance) {
			bool ret = instance->ptr != instance->sliceEnd;
			return ret;
	}
	...
	void cv_MatConstIterator_propElemSize_size_t(cv::MatConstIterator* instance, size_t val) {
	...
	void cv_MatExpr_propFlags_int(cv::MatExpr* instance, int val) {
			instance->flags = val;
	}
	...
	void cv_MatExpr_propA_Mat(cv::MatExpr* instance, cv::Mat* val) {
			instance->a = *val;
	}
	...
	void cv_MatExpr_propB_Mat(cv::MatExpr* instance, cv::Mat* val) {
			instance->b = *val;
	}
	...
	void cv_MatExpr_propC_Mat(cv::MatExpr* instance, cv::Mat* val) {
			instance->c = *val;
	}
	...
	void cv_MatExpr_propAlpha_double(cv::MatExpr* instance, double val) {
			instance->alpha = val;
	}
	...
	void cv_MatExpr_propBeta_double(cv::MatExpr* instance, double val) {
			instance->beta = val;
	}
	...
	void cv_MatExpr_propS_Scalar(cv::MatExpr* instance, cv::Scalar* val) {
			instance->s = *val;
	}
	...
	void cv_MatSize_propP_intX(cv::MatSize* instance, int* val) {
			instance->p = val;
	}
	...
	void cv_MatStep_propP_size_tX(cv::MatStep* instance, size_t* val) {
			instance->p = val;
	}
	...
	void cv_PCA_propEigenvectors_Mat(cv::PCA* instance, cv::Mat* val) {
	...
	void cv_PCA_propEigenvalues_Mat(cv::PCA* instance, cv::Mat* val) {
	...
	void cv_PCA_propMean_Mat(cv::PCA* instance, cv::Mat* val) {
			instance->mean = *val;
	}
	...
	void cv_RNG_propState_uint64_t(cv::RNG* instance, uint64_t val) {
			instance->state = val;
	}
	...
	void cv_Range_propStart_int(cv::Range* instance, int val) {
			instance->start = val;
	}
	...
	void cv_Range_propEnd_int(cv::Range* instance, int val) {
			instance->end = val;
	}
	...
	void cv_SVD_propU_Mat(cv::SVD* instance, cv::Mat* val) {
			instance->u = *val;
	}
	...
	void cv_SVD_propW_Mat(cv::SVD* instance, cv::Mat* val) {
			instance->w = *val;
	}
	...
	void cv_SVD_propVt_Mat(cv::SVD* instance, cv::Mat* val) {
			instance->vt = *val;
	}
	...
	void cv_SparseMat_propFlags_int(cv::SparseMat* instance, int val) {
			instance->flags = val;
	}
	...
	void cv_SparseMat_propHdr_HdrX(cv::SparseMat* instance, cv::SparseMat::Hdr* val) {
			instance->hdr = val;
	}
	...
	void cv_SparseMat_Hdr_propRefcount_int(cv::SparseMat::Hdr* instance, int val) {
	...
	void cv_SparseMat_Hdr_propDims_int(cv::SparseMat::Hdr* instance, int val) {
			instance->dims = val;
	}
	...
	void cv_SparseMat_Hdr_propValueOffset_int(cv::SparseMat::Hdr* instance, int val) {
	...
	void cv_SparseMat_Hdr_propNodeSize_size_t(cv::SparseMat::Hdr* instance, size_t val) {
	...
	void cv_SparseMat_Hdr_propNodeCount_size_t(cv::SparseMat::Hdr* instance, size_t val) {
	...
	void cv_SparseMat_Hdr_propFreeList_size_t(cv::SparseMat::Hdr* instance, size_t val) {
	...
	void cv_SparseMat_Hdr_propPool_vectorLunsigned_charG(cv::SparseMat::Hdr* instance, std::vector<unsigned char>* val) {
			instance->pool = *val;
	}
	...
	void cv_SparseMat_Hdr_propHashtab_vectorLsize_tG(cv::SparseMat::Hdr* instance, std::vector<size_t>* val) {
	...
	void cv_SparseMat_Node_propHashval_size_t(cv::SparseMat::Node* instance, size_t val) {
	...
	void cv_SparseMat_Node_propNext_size_t(cv::SparseMat::Node* instance, size_t val) {
			instance->next = val;
	}
	...
	void cv_SparseMatConstIterator_propHashidx_size_t(cv::SparseMatConstIterator* instance, size_t val) {
	...
	void cv_SparseMatConstIterator_propPtr_unsigned_charX(cv::SparseMatConstIterator* instance, unsigned char* val) {
			instance->ptr = val;
	}
	...
	void cv_UMat_propFlags_int(cv::UMat* instance, int val) {
			instance->flags = val;
	}
	...
	void cv_UMat_propDims_int(cv::UMat* instance, int val) {
			instance->dims = val;
	}
	...
	void cv_UMat_propRows_int(cv::UMat* instance, int val) {
			instance->rows = val;
	}
	...
	void cv_UMat_propCols_int(cv::UMat* instance, int val) {
			instance->cols = val;
	}
	...
	void cv_UMat_propUsageFlags_UMatUsageFlags(cv::UMat* instance, cv::UMatUsageFlags val) {
	...
	void cv_UMat_propU_UMatDataX(cv::UMat* instance, cv::UMatData* val) {
			instance->u = val;
	}
	...
	void cv_UMat_propOffset_size_t(cv::UMat* instance, size_t val) {
			instance->offset = val;
	}
	...
	void cv_UMatData_propUrefcount_int(cv::UMatData* instance, int val) {
	...
	void cv_UMatData_propRefcount_int(cv::UMatData* instance, int val) {
			instance->refcount = val;
	}
	...
	void cv_UMatData_propData_unsigned_charX(cv::UMatData* instance, unsigned char* val) {
			instance->data = val;
	}
	...
	void cv_UMatData_propOrigdata_unsigned_charX(cv::UMatData* instance, unsigned char* val) {
	...
	void cv_UMatData_propSize_size_t(cv::UMatData* instance, size_t val) {
			instance->size = val;
	}
	...
	void cv_UMatData_propFlags_MemoryFlag(cv::UMatData* instance, cv::UMatData::MemoryFlag val) {
			instance->flags = val;
	}
	...
	void cv_UMatData_propHandle_voidX(cv::UMatData* instance, void* val) {
			instance->handle = val;
	}
	...
	void cv_UMatData_propUserdata_voidX(cv::UMatData* instance, void* val) {
	...
	void cv_UMatData_propAllocatorFlags__int(cv::UMatData* instance, int val) {
	...
	void cv_UMatData_propMapcount_int(cv::UMatData* instance, int val) {
	...
	void cv_UMatData_propOriginalUMatData_UMatDataX(cv::UMatData* instance, cv::UMatData* val) {
	...
	void cv_cuda_GpuData_propData_unsigned_charX(cv::cuda::GpuData* instance, unsigned char* val) {
			instance->data = val;
	}
	...
	void cv_cuda_GpuData_propSize_size_t(cv::cuda::GpuData* instance, size_t val) {
			instance->size = val;
	}
	...
	void cv_cuda_GpuMat_propFlags_int(cv::cuda::GpuMat* instance, int val) {
			instance->flags = val;
	}
	...
	void cv_cuda_GpuMat_propRows_int(cv::cuda::GpuMat* instance, int val) {
			instance->rows = val;
	}
	...
	void cv_cuda_GpuMat_propCols_int(cv::cuda::GpuMat* instance, int val) {
			instance->cols = val;
	}
	...
	void cv_cuda_GpuMat_propStep_size_t(cv::cuda::GpuMat* instance, size_t val) {
			instance->step = val;
	}
	...
	void cv_cuda_GpuMat_propData_unsigned_charX(cv::cuda::GpuMat* instance, unsigned char* val) {
			instance->data = val;
	}
	...
	void cv_cuda_GpuMat_propRefcount_intX(cv::cuda::GpuMat* instance, int* val) {
			instance->refcount = val;
	}
	...
	void cv_cuda_GpuMat_propDatastart_unsigned_charX(cv::cuda::GpuMat* instance, unsigned char* val) {
	...
	void cv_cuda_GpuMat_propAllocator_AllocatorX(cv::cuda::GpuMat* instance, cv::cuda::GpuMat::Allocator* val) {
	...
	void cv_cuda_GpuMatND_propFlags_int(cv::cuda::GpuMatND* instance, int val) {
			instance->flags = val;
	}
	...
	void cv_cuda_GpuMatND_propDims_int(cv::cuda::GpuMatND* instance, int val) {
			instance->dims = val;
	}
	...
	void cv_cuda_GpuMatND_propSize_SizeArray(cv::cuda::GpuMatND* instance, cv::cuda::GpuMatND::SizeArray* val) {
			instance->size = *val;
	}
	...
	void cv_cuda_GpuMatND_propStep_StepArray(cv::cuda::GpuMatND* instance, cv::cuda::GpuMatND::StepArray* val) {
			instance->step = *val;
	}
	...
	void cv_cuda_HostMem_propFlags_int(cv::cuda::HostMem* instance, int val) {
			instance->flags = val;
	}
	...
	void cv_cuda_HostMem_propRows_int(cv::cuda::HostMem* instance, int val) {
			instance->rows = val;
	}
	...
	void cv_cuda_HostMem_propCols_int(cv::cuda::HostMem* instance, int val) {
			instance->cols = val;
	}
	...
	void cv_cuda_HostMem_propStep_size_t(cv::cuda::HostMem* instance, size_t val) {
			instance->step = val;
	}
	...
	void cv_cuda_HostMem_propData_unsigned_charX(cv::cuda::HostMem* instance, unsigned char* val) {
			instance->data = val;
	}
	...
	void cv_cuda_HostMem_propRefcount_intX(cv::cuda::HostMem* instance, int* val) {
			instance->refcount = val;
	}
	...
	void cv_cuda_HostMem_propDatastart_unsigned_charX(cv::cuda::HostMem* instance, unsigned char* val) {
			instance->datastart = val;
	}
	...
	void cv_cuda_HostMem_propAlloc_type_AllocType(cv::cuda::HostMem* instance, cv::cuda::HostMem::AllocType val) {
	...
	void cv_detail_CheckContext_propLine_int(cv::detail::CheckContext* instance, int val) {
			instance->line = val;
	}
	...
	void cv_detail_CheckContext_propTestOp_TestOp(cv::detail::CheckContext* instance, cv::detail::TestOp val) {
			instance->testOp = val;
	}
	...
	void cv_instr_NodeData_propM_funName_String(cv::instr::NodeData* instance, char* val) {
	...
	void cv_instr_NodeData_propM_instrType_TYPE(cv::instr::NodeData* instance, cv::instr::TYPE val) {
	...
	void cv_instr_NodeData_propM_implType_IMPL(cv::instr::NodeData* instance, cv::instr::IMPL val) {
	...
	void cv_instr_NodeData_propM_lineNum_int(cv::instr::NodeData* instance, int val) {
	...
	void cv_instr_NodeData_propM_retAddress_voidX(cv::instr::NodeData* instance, void* val) {
	...
	void cv_instr_NodeData_propM_alwaysExpand_bool(cv::instr::NodeData* instance, bool val) {
	...
	void cv_instr_NodeData_propM_funError_bool(cv::instr::NodeData* instance, bool val) {
	...
	void cv_instr_NodeData_propM_counter_int(cv::instr::NodeData* instance, int val) {
	...
	void cv_instr_NodeData_propM_ticksTotal_uint64_t(cv::instr::NodeData* instance, uint64_t val) {
	...
	void cv_instr_NodeData_propM_threads_int(cv::instr::NodeData* instance, int val) {
	...
	void cv_ocl_KernelArg_propFlags_int(cv::ocl::KernelArg* instance, int val) {
			instance->flags = val;
	}
	...
	void cv_ocl_KernelArg_propM_UMatX(cv::ocl::KernelArg* instance, cv::UMat* val) {
			instance->m = val;
	}
	...
	void cv_ocl_KernelArg_propSz_size_t(cv::ocl::KernelArg* instance, size_t val) {
			instance->sz = val;
	}
	...
	void cv_ocl_KernelArg_propWscale_int(cv::ocl::KernelArg* instance, int val) {
			instance->wscale = val;
	}
	...
	void cv_ocl_KernelArg_propIwscale_int(cv::ocl::KernelArg* instance, int val) {
	...
	void cv_utils_logging_LogTag_propLevel_LogLevel(cv::utils::logging::LogTag* instance, cv::utils::logging::LogLevel val) {
			instance->level = val;
	}
	...
	void cv_utils_nested_OriginalClassName_OriginalClassName_const_ParamsR(const cv::utils::nested::OriginalClassName::Params* params, Result<cv::utils::nested::OriginalClassName*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::utils::nested::OriginalClassName*>, ocvrs_return);
	}
	...
	void cv_utils_nested_OriginalClassName_create_const_ParamsR(const cv::utils::nested::OriginalClassName::Params* params, Result<cv::Ptr<cv::utils::nested::OriginalClassName>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::utils::nested::OriginalClassName>*>, ocvrs_return);
	}
	...
	void cv_utils_nested_OriginalClassName_Params_Params_int_float(int int_param, float float_param, Result<cv::utils::nested::OriginalClassName::Params>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::utils::nested::OriginalClassName::Params>, ocvrs_return);
	}
