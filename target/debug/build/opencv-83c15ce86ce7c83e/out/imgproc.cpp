...
extern "C" {
	...
	void cv_LineIterator_propPtr_unsigned_charX(cv::LineIterator* instance, unsigned char* val) {
			instance->ptr = val;
	}
	...
	void cv_LineIterator_propStep_int(cv::LineIterator* instance, int val) {
			instance->step = val;
	}
	...
	void cv_LineIterator_propElemSize_int(cv::LineIterator* instance, int val) {
	...
	void cv_LineIterator_propErr_int(cv::LineIterator* instance, int val) {
			instance->err = val;
	}
	...
	void cv_LineIterator_propCount_int(cv::LineIterator* instance, int val) {
			instance->count = val;
	}
	...
	void cv_LineIterator_propMinusDelta_int(cv::LineIterator* instance, int val) {
	...
	void cv_LineIterator_propPlusDelta_int(cv::LineIterator* instance, int val) {
	...
	void cv_LineIterator_propMinusStep_int(cv::LineIterator* instance, int val) {
	...
	void cv_LineIterator_propPlusStep_int(cv::LineIterator* instance, int val) {
	...
	void cv_LineIterator_propMinusShift_int(cv::LineIterator* instance, int val) {
	...
	void cv_LineIterator_propPlusShift_int(cv::LineIterator* instance, int val) {
	...
	void cv_LineIterator_propP_Point(cv::LineIterator* instance, cv::Point* val) {
			instance->p = *val;
	}
	...
	void cv_LineIterator_propPtmode_bool(cv::LineIterator* instance, bool val) {
			instance->ptmode = val;
	}
